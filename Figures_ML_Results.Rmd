...
```{r, combined proportion per category figure, fig.width=7, fig.height=6}
combined = ggarrange(
 ...
 heights= c(0.55, 0.45), nrow=2, legend = "none"
)
combined
ggsave('./figures/Fig1_prop_per_category_all_datasets.png', combined, width=7, height=6, dpi=300)
```
